My AI Idea:
A job Applier project, where i will create an extension, which when enabled, which will see my screen apply all the fields, according to my resume. When i will change the field which AI has applied it should give a feedback loop on what it did wrong and should not do it again.
 
A job finder app: to find relevant jobs, matching my skills up-to 50 percent
